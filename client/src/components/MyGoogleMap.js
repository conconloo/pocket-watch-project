                    ...
                    {this.state.crime_data[0] ? 
                        ...
                        : console.log("undefined")}{this.state.crime_data[15] ? 
                            <Polygon
                                ...
                                options={{fillColor: `rgba(0,0,255,${this.state.crime_data[15].mag/62577}`}}
                            />
